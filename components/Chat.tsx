...
function Chat({chatId}: Props) {
  ...
  return (
    <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-rounded-full h-32 scrollbar-thumb-gray-400 scrollbar-track-[#434654]">
      {messages?.empty && (
        <>
